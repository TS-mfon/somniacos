    ...
    body: [
      {
        ...
        paragraphs: [
          ...
          "The agent API is `/api/agents/run`. It accepts agent id, task, constraints, URLs, mission id, output format, memory, request id, and transaction hash. It uses OpenAI when configured, public fallback when needed, and a deterministic local fallback to avoid blank demo failures."
        ],
        bullets: [
